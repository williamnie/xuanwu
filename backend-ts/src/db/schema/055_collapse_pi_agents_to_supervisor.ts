...
export const collapsePiAgentsToSupervisorMigration: SqlMigration = {
  ...
  sql: `
update project_pi_settings
  set pi_agent_id='runner-default'
  where pi_agent_id<>'runner-default'
...
update pi_agents
  ...
  where id='runner-default'
    and name in ('PI Assistant', 'Runner Agent', 'Runner Brain');
