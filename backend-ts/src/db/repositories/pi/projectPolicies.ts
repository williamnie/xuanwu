...
function normalizePolicy(input: ProjectPiPolicyInput): ProjectPiPolicy {
  return {
    ...
    supervisor_max_recoveries_per_issue: positiveInteger(input.supervisor_max_recoveries_per_issue, 6),
    supervisor_max_recoveries_per_project_per_hour: 0,
...
function mapProjectPiPolicy(row: Record<string, unknown>): ProjectPiPolicy {
  return {
    ...
    supervisor_max_recoveries_per_issue: positiveInteger(row.supervisor_max_recoveries_per_issue, 6),
    supervisor_max_recoveries_per_project_per_hour: 0,
