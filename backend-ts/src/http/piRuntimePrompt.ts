...
function legacyWorkToolWorkflow(): string {
  return [
    ...
    "When new Work or a proposed Issue depends on existing Issues, pass their numeric ids in depends_on_issue_ids to work_create or issue_create_proposal. Do not encode hard dependencies only as Markdown; the structured field is the scheduler authority.",
